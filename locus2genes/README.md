...
When providing more than one locus, provide them with the '-r' as a comma-separated list of chr&#58;start&#58;end without spaces (see example below). If you use 'chr' to name your chromosomes, it will be removed to comply with the ensembl nomenclature. Note that you can provide loci with strand as fourth parameter if you have obtained strand-specific results (eg: chr&#58;startEEnd&#58;1 for the upper strand ('-1' for the '-' strand).
